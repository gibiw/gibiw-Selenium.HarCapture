...
- [x] **FBK-02**: Library automatically detects whether to use CDP or INetwork based on driver capabilities
- [x] **FBK-03**: Library falls back to INetwork at runtime if CDP session creation fails
