...
/// <summary>
/// CDP Network adapter for Chrome DevTools Protocol V144.
/// </summary>
internal sealed class CdpNetworkAdapterV144 : ICdpNetworkAdapter
{
    ...
    internal CdpNetworkAdapterV144(DevToolsSession session)
    {
