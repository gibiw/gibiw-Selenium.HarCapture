...
/// <summary>
/// CDP Network adapter for Chrome DevTools Protocol V142.
/// </summary>
internal sealed class CdpNetworkAdapterV142 : ICdpNetworkAdapter
{
    ...
    internal CdpNetworkAdapterV142(DevToolsSession session)
    {
